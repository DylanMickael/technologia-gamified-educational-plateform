...
const Console: React.FC<ConsoleProps> = ({ consoleOutput }) => {
    return (
      <div data-aos="fade-up" data-aos-delay="200" className="shadow-[0_4px_24px_0_rgba(78,78,78,0.15)] rounded-2xl min-h-32 md:min-h-52 bg-background-orange dark:from-gray-900 dark:via-gray-50 dark:to-gray-900 text-gray-300 p-2 md:p-4 border border-blue-100 dark:border-gray-700 overflow-auto font-mono whitespace-pre-wrap mt-4 md:mt-6">
