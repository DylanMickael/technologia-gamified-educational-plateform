...
| ----------------- | ------------------------------------------------------------------ | -------------------------- |
| 🏠 API principale | [http://localhost:3000](http://localhost:3000)                     | Point d’entrée principal   |
| 📚 Swagger        | [http://localhost:3000/api-docs](http://localhost:3000/api-docs)   | Interface de test des APIs |
| 📊 Dashboard      | [http://localhost:3000/dashboard](http://localhost:3000/dashboard) | Métriques temps réel       |
| 💚 Health check   | [http://localhost:3000/health](http://localhost:3000/health)       | État du serveur            |
...
| --------------------------------------------- | ------------ | ----- |
| [admin@ecocity.com](mailto:admin@ecocity.com) | admin123     | admin |
